# Java Draughts (Checkers) Game — DSA Coursework
...
A lightweight, memory-optimized 8x8 Draughts (Checkers) game implemented in Java Swing. Features a single-player mode against an automated AI opponent powered by a recursive **Minimax Game Tree Search** algorithm.
...
5. **Rule Validation & Forced Captures (`MoveLogic.java`)**: Enforces official draughts rules, including mandatory capture jumps and diagonal vector displacement.
